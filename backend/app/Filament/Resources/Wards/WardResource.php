...
class WardResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'Danh sách Phường / Xã';
    protected static ?string $navigationLabel = 'Danh sách Phường / Xã';
    protected static \UnitEnum|string|null $navigationGroup = 'Địa giới Hành chính';
